...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_nativeaudio);
        ...
        ((Button) findViewById(R.id.channels_uri)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                Toast.makeText(MainActivity.this, "Channels: " + numChannelsUri, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        ((SeekBar) findViewById(R.id.pan_uri)).setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            int lastProgress = 100;
