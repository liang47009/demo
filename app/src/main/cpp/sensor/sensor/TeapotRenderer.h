...
#include <ndk_helper/shader.h>            //Shader compiler support
#include <ndk_helper/vecmath.h>            //Vector math support, C++ implementation n current version
#include <ndk_helper/tapCamera.h>          //Tap/Pinch camera control
