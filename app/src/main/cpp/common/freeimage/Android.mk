...
LOCAL_SRC_FILES:= Source/CacheFile.h \
...
LOCAL_CFLAGS	:= -I${LOCAL_PATH}/Source
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/LibJPEG
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/FreeImage
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/ZLib
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/DeprecationManager
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/Metadata
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/LibRawLite
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/LibRawLite/libraw
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/OpenEXR/IlmThread
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/FreeImageToolkit
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/LibOpenJPEG
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/LibPNG
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/OpenEXR/Imath
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/LibRawLite\internal
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/OpenEXR
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/OpenEXR/Iex
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/LibTIFF4
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/OpenEXR/Half
LOCAL_CFLAGS	+= -I${LOCAL_PATH}/Source/OpenEXR/IlmImf
